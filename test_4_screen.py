...
now_date = datetime.datetime.utcnow().strftime("%Y.№m.%d.%H.%M.")#datetime дает нам выбрать дату
name_screenshot = 'screenshot' + now_date + '.png'# название скриншота и дата в переменную
driver.save_screenshot('C:\\Users\\user\\Desktop\\PycharmProjects\\pythonselenium\\screen\\' + name_screenshot)#указание пути куда сохранять